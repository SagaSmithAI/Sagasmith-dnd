...
__all__ = [
    ...
    "resolve_official_expansion_archives",  # noqa: F822 - lazy compatibility export
    "resolve_official_expansion_support_archives",  # noqa: F822 - lazy compatibility export
    "verify_official_expansion_library",  # noqa: F822 - lazy compatibility export
]

# Compatibility only: new application code imports Runtime directly.
_RUNTIME_EXPORTS = (
    '_content_library_root',
    '_portable_archive_path',
    '_read_descriptor',
...
def __getattr__(name: str):
    ...
    return runtime_attribute('official_library', name)
