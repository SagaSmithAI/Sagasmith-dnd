...
TORTLE_SHELL_DEFENSE_CURRENT_PACK_VERSION = "1.0.2"
...
TORTLE_SHELL_DEFENSE_CURRENT_SELECTION_MECHANIC_REFS = frozenset(
    {
...
TORTLE_NATURAL_ARMOR_CONTENT_PACKAGE_VERSION = "1.0.3-local.clause-coverage.1"
TORTLE_NATURAL_ARMOR_CONTENT_PACKAGE_CHECKSUM = (
    "5ec313b5acb9cec7019432f29b604ee00b26a139a320527d27c2e1fbe80cf360"
)
TORTLE_NATURAL_ARMOR_LEGACY_CONTENT_PACKAGE_VERSION = "1.0.1"
TORTLE_NATURAL_ARMOR_LEGACY_CONTENT_PACKAGE_CHECKSUM = (
    "356cbf231ea7ecf8dab48b7cca127523d1d0bd3f5b5535899f45641f24bc5759"
)
# Existing actor-bound signed authorities retain their exact historical identity.
TORTLE_NATURAL_ARMOR_CONTENT_IDENTITIES = frozenset({
...
# The 1.0.1 archive carries the immutable 1.0.0 runtime rule definition.
TORTLE_NATURAL_ARMOR_LEGACY_PACK_VERSIONS = frozenset({"1.0.0"})
TORTLE_NATURAL_ARMOR_CURRENT_PACK_VERSION = "1.0.2"
TORTLE_NATURAL_ARMOR_CURRENT_SELECTION_MECHANIC_REFS = frozenset(
    {
        CORE_TORTLE_NATURAL_ARMOR_MECHANIC_ID,
        CORE_TORTLE_SHELL_DEFENSE_MECHANIC_ID,
    }
...
TORTLE_HOLD_BREATH_LEGACY_PACK_VERSIONS = frozenset({"1.0.0", "1.0.1", "1.0.2"})
