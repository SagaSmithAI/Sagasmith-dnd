...
BOUNDARIES = (
    ...
    CoreBoundary(
        "dnd5e.core.class.divine_smite",
        ("2014",),
        "divine_smite.settle|combat_engine.resolve_attack_damage",
        ("tests/test_divine_smite.py", "packages/mcp/tests/test_divine_smite_mcp.py"),
        "bundled:srd2014/02_Classes/Paladin.md#divine-smite",
    ),
    CoreBoundary(
    ...
    CoreBoundary(
        "dnd5e.core.check.working_together",
        ("2014",),
    ...
    CoreBoundary(
        ...
        ("tests/test_sunlight.py",),
        "book:players-handbook-2014:p24",
    ),
    CoreBoundary(
        "dnd5e.core.objects.damage",
        ("2014",),
        "objects.validate_object_profile|apply_object_damage|resolve_object_attack",
        ("tests/test_objects.py",),
        "bundled:srd2014/08_Gamemastering/Objects.md",
    ),
    CoreBoundary(
