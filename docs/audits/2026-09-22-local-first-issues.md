...
| [#164](https://github.com/SagaSmithAI/Sagasmith-dnd/issues/164) | Implement generic source-correct 2014 passive checks | Open: still aligned with source-correct local gameplay; full acceptance is not established. |
| [#163](https://github.com/SagaSmithAI/Sagasmith-dnd/issues/163) | Implement 2014 lifestyle and downtime activity settlement | Open: still aligned with source-correct local gameplay; full acceptance is not established. |
| [#162](https://github.com/SagaSmithAI/Sagasmith-dnd/issues/162) | Implement source-correct 2014 madness effects and cures | Open: still aligned with source-correct local gameplay; full acceptance is not established. |
| [#161](https://github.com/SagaSmithAI/Sagasmith-dnd/issues/161) | Implement source-bound 2014 trap detection, disabling, and settlement | Open: still aligned with source-correct local gameplay; full acceptance is not established. |
| [#160](https://github.com/SagaSmithAI/Sagasmith-dnd/issues/160) | Implement source-correct 2014 poison delivery and lifecycles | Open: still aligned with source-correct local gameplay; full acceptance is not established. |
| [#159](https://github.com/SagaSmithAI/Sagasmith-dnd/issues/159) | Implement source-correct 2014 disease lifecycles | Open: still aligned with source-correct local gameplay; full acceptance is not established. |
| [#158](https://github.com/SagaSmithAI/Sagasmith-dnd/issues/158) | Fix 2014 scene-object attack and damage-threshold settlement | Open: still aligned with source-correct local gameplay; full acceptance is not established. |
| [#157](https://github.com/SagaSmithAI/Sagasmith-dnd/issues/157) | Implement source-correct 2014 travel pace and forced-march settlement | Open: still aligned with source-correct local gameplay; full acceptance is not established. |
| [#152](https://github.com/SagaSmithAI/Sagasmith-dnd/issues/152) | Implement source-correct 2014 vision, obscuration, and light settlement | Open: still aligned with source-correct local gameplay; full acceptance is not established. |
| [#151](https://github.com/SagaSmithAI/Sagasmith-dnd/issues/151) | Implement 2014 food, water, and starvation exhaustion lifecycle | Open: still aligned with source-correct local gameplay; full acceptance is not established. |
| [#150](https://github.com/SagaSmithAI/Sagasmith-dnd/issues/150) | Implement source-correct 2014 long-jump and high-jump settlement | Open: still aligned with source-correct local gameplay; full acceptance is not established. |
...
| [#111](https://github.com/SagaSmithAI/Sagasmith-dnd/issues/111) | Implement actual 2014 Barbarian Rage settlement | Open: still aligned with source-correct local gameplay; full acceptance is not established. |
| [#110](https://github.com/SagaSmithAI/Sagasmith-dnd/issues/110) | Bind opportunity-attack triggers to weapon reach | Open: still aligned with source-correct local gameplay; full acceptance is not established. |
| [#109](https://github.com/SagaSmithAI/Sagasmith-dnd/issues/109) | Model off-turn self-powered movement for opportunity attacks | Open: still aligned with source-correct local gameplay; full acceptance is not established. |
