...
- Bladesong is a bonus action with two source-defined uses and short-rest recovery. The acceptance test now verifies DM authorization and forged-override rejection, active effects, short-rest refill, long-rest refill, voluntary dismissal, and two-handed attack termination with the persisted `two_handed_attack` reason.
