...
| `adventuring_gear_action` | combat, lobby, play | expected_actor_revision, expected_target_revision, expected_revision | True |
...
| `character_disease_cure` | combat, lobby, play | expected_revision, expected_actor_revision | True |
| `character_disease_end_turn` | combat, lobby, play | expected_revision, expected_actor_revision | True |
| `character_disease_exposure` | combat, lobby, play | expected_revision, expected_actor_revision | True |
| `character_disease_exposure_batch` | combat, lobby, play | expected_actor_revisions, expected_revision | True |
| `character_disease_eyebright_apply` | combat, lobby, play | expected_revision, expected_actor_revision | True |
| `character_disease_eyebright_craft` | combat, lobby, play | expected_revision, expected_actor_revision | True |
| `character_disease_stress` | combat, lobby, play | expected_revision, expected_actor_revision | True |
| `character_downtime_settle` | lobby, play | expected_revision, expected_actor_revision | True |
...
| `trap_state_transition` | combat, lobby, play | expected_revision | True |
...
```json
{"additionalProperties":false,"properties":{"campaign_id":{"title":"Campaign Id","type":"string","description":"Authoritative campaign identifier.","maxLength":256},"action_id":{"title":"Action Id","type":"string","description":"Bounded action id value accepted by adventuring_gear_action.","maxLength":256},"item_id":{"title":"Item Id","type":"string","description":"Bounded item id value accepted by adventuring_gear_action.","maxLength":256},"intent":{"title":"Intent","type":"string","description":"Bounded intent value accepted by adventuring_gear_action."},"source_ref":{"title":"Source Ref","type":"string","description":"Bounded source ref value accepted by adventuring_gear_action."},"actor_id":{"title":"Actor Id","type":"string","description":"Authoritative campaign actor identifier.","maxLength":256},"expected_actor_revision":{"title":"Expected Actor Revision","type":"integer","description":"Bounded expected actor revision value accepted by adventuring_gear_action."},"target_actor_id":{"anyOf":[{"type":"string"},{"type":"null"}],"default":null,"title":"Target Actor Id","description":"Bounded target actor id value accepted by adventuring_gear_action.","maxLength":256},"expected_target_revision":{"anyOf":[{"type":"integer"},{"type":"null"}],"default":null,"title":"Expected Target Revision","description":"Bounded expected target revision value accepted by adventuring_gear_action."},"principal_id":{"default":"system:local","title":"Principal Id","type":"string","description":"Caller hint overwritten by process binding or signed Host delegation.","maxLength":256},"expected_revision":{"anyOf":[{"type":"integer"},{"type":"null"}],"default":null,"title":"Expected Revision","description":"Authority revision guard used to reject stale mutations."},"branch_id":{"anyOf":[{"type":"string"},{"type":"null"}],"default":null,"title":"Branch Id","description":"Authoritative timeline branch identifier.","maxLength":256},"idempotency_key":{"anyOf":[{"type":"string"},{"type":"null"}],"default":null,"title":"Idempotency Key","description":"Stable business-operation key reused unchanged across retries.","maxLength":256},"action_context":{"anyOf":[{"additionalProperties":true,"type":"object"},{"type":"null"}],"default":null,"title":"Action Context","description":"Bounded action context value accepted by adventuring_gear_action."},"target_object":{"anyOf":[{"additionalProperties":true,"type":"object"},{"type":"null"}],"default":null,"title":"Target Object","description":"Bounded target object value accepted by adventuring_gear_action."},"object_source_ref":{"anyOf":[{"additionalProperties":true,"type":"object"},{"type":"null"}],"default":null,"title":"Object Source Ref","description":"Bounded object source ref value accepted by adventuring_gear_action."},"object_reason":{"anyOf":[{"type":"string"},{"type":"null"}],"default":null,"title":"Object Reason","description":"Bounded object reason value accepted by adventuring_gear_action."},"object_ruling":{"anyOf":[{"additionalProperties":true,"type":"object"},{"type":"null"}],"default":null,"title":"Object Ruling","description":"Bounded object ruling value accepted by adventuring_gear_action."},"attack_ruling":{"anyOf":[{"additionalProperties":true,"type":"object"},{"type":"null"}],"default":null,"title":"Attack Ruling","description":"Bounded attack ruling value accepted by adventuring_gear_action."},"helper_actor_id":{"anyOf":[{"type":"string"},{"type":"null"}],"default":null,"title":"Helper Actor Id","description":"Bounded helper actor id value accepted by adventuring_gear_action.","maxLength":256}},"required":["campaign_id","action_id","item_id","intent","source_ref","actor_id","expected_actor_revision"],"title":"adventuring_gear_actionInput","type":"object"}
```
...
```json
{"additionalProperties":false,"properties":{"campaign_id":{"title":"Campaign Id","type":"string","description":"Authoritative campaign identifier.","maxLength":256},"actor_id":{"title":"Actor Id","type":"string","description":"Authoritative campaign actor identifier.","maxLength":256},"disease_effect_id":{"title":"Disease Effect Id","type":"string","description":"Bounded disease effect id value accepted by character_disease_cure.","maxLength":256},"cure_source_id":{"title":"Cure Source Id","type":"string","description":"Bounded cure source id value accepted by character_disease_cure.","maxLength":256},"cure_source_ref":{"title":"Cure Source Ref","type":"string","description":"Bounded cure source ref value accepted by character_disease_cure."},"principal_id":{"default":"system:local","title":"Principal Id","type":"string","description":"Caller hint overwritten by process binding or signed Host delegation.","maxLength":256},"expected_revision":{"anyOf":[{"type":"integer"},{"type":"null"}],"default":null,"title":"Expected Revision","description":"Authority revision guard used to reject stale mutations."},"expected_actor_revision":{"anyOf":[{"type":"integer"},{"type":"null"}],"default":null,"title":"Expected Actor Revision","description":"Bounded expected actor revision value accepted by character_disease_cure."},"branch_id":{"anyOf":[{"type":"string"},{"type":"null"}],"default":null,"title":"Branch Id","description":"Authoritative timeline branch identifier.","maxLength":256},"idempotency_key":{"anyOf":[{"type":"string"},{"type":"null"}],"default":null,"title":"Idempotency Key","description":"Stable business-operation key reused unchanged across retries.","maxLength":256}},"required":["campaign_id","actor_id","disease_effect_id","cure_source_id","cure_source_ref"],"title":"character_disease_cureInput","type":"object"}
```
...
```json
{"additionalProperties":false,"properties":{"campaign_id":{"title":"Campaign Id","type":"string","description":"Authoritative campaign identifier.","maxLength":256},"actor_id":{"title":"Actor Id","type":"string","description":"Authoritative campaign actor identifier.","maxLength":256},"principal_id":{"default":"system:local","title":"Principal Id","type":"string","description":"Caller hint overwritten by process binding or signed Host delegation.","maxLength":256},"expected_revision":{"anyOf":[{"type":"integer"},{"type":"null"}],"default":null,"title":"Expected Revision","description":"Authority revision guard used to reject stale mutations."},"expected_actor_revision":{"anyOf":[{"type":"integer"},{"type":"null"}],"default":null,"title":"Expected Actor Revision","description":"Bounded expected actor revision value accepted by character_disease_end_turn."},"branch_id":{"anyOf":[{"type":"string"},{"type":"null"}],"default":null,"title":"Branch Id","description":"Authoritative timeline branch identifier.","maxLength":256},"idempotency_key":{"anyOf":[{"type":"string"},{"type":"null"}],"default":null,"title":"Idempotency Key","description":"Stable business-operation key reused unchanged across retries.","maxLength":256}},"required":["campaign_id","actor_id"],"title":"character_disease_end_turnInput","type":"object"}
```
...
```json
{"additionalProperties":false,"properties":{"campaign_id":{"title":"Campaign Id","type":"string","description":"Authoritative campaign identifier.","maxLength":256},"actor_id":{"title":"Actor Id","type":"string","description":"Authoritative campaign actor identifier.","maxLength":256},"disease_id":{"title":"Disease Id","type":"string","description":"Bounded disease id value accepted by character_disease_exposure.","maxLength":256},"exposure_kind":{"title":"Exposure Kind","type":"string","description":"Bounded exposure kind value accepted by character_disease_exposure."},"exposure_source_id":{"title":"Exposure Source Id","type":"string","description":"Bounded exposure source id value accepted by character_disease_exposure.","maxLength":256},"exposure_source_ref":{"title":"Exposure Source Ref","type":"string","description":"Bounded exposure source ref value accepted by character_disease_exposure."},"source_actor_id":{"anyOf":[{"type":"string"},{"type":"null"}],"default":null,"title":"Source Actor Id","description":"Bounded source actor id value accepted by character_disease_exposure.","maxLength":256},"target_turn_start":{"anyOf":[{"type":"boolean"},{"type":"null"}],"default":null,"title":"Target Turn Start","description":"Bounded target turn start value accepted by character_disease_exposure."},"within_10_feet":{"anyOf":[{"type":"boolean"},{"type":"null"}],"default":null,"title":"Within 10 Feet","description":"Bounded within 10 feet value accepted by character_disease_exposure."},"principal_id":{"default":"system:local","title":"Principal Id","type":"string","description":"Caller hint overwritten by process binding or signed Host delegation.","maxLength":256},"expected_revision":{"anyOf":[{"type":"integer"},{"type":"null"}],"default":null,"title":"Expected Revision","description":"Authority revision guard used to reject stale mutations."},"expected_actor_revision":{"anyOf":[{"type":"integer"},{"type":"null"}],"default":null,"title":"Expected Actor Revision","description":"Bounded expected actor revision value accepted by character_disease_exposure."},"branch_id":{"anyOf":[{"type":"string"},{"type":"null"}],"default":null,"title":"Branch Id","description":"Authoritative timeline branch identifier.","maxLength":256},"idempotency_key":{"anyOf":[{"type":"string"},{"type":"null"}],"default":null,"title":"Idempotency Key","description":"Stable business-operation key reused unchanged across retries.","maxLength":256}},"required":["campaign_id","actor_id","disease_id","exposure_kind","exposure_source_id","exposure_source_ref"],"title":"character_disease_exposureInput","type":"object"}
```
...
```json
{"additionalProperties":false,"properties":{"campaign_id":{"title":"Campaign Id","type":"string","description":"Authoritative campaign identifier.","maxLength":256},"carrier_actor_id":{"title":"Carrier Actor Id","type":"string","description":"Bounded carrier actor id value accepted by character_disease_exposure_batch.","maxLength":256},"target_actor_ids":{"items":{"type":"string"},"title":"Target Actor Ids","type":"array","description":"Bounded target actor ids value accepted by character_disease_exposure_batch.","maxItems":1000},"exposure_source_ref":{"title":"Exposure Source Ref","type":"string","description":"Bounded exposure source ref value accepted by character_disease_exposure_batch."},"target_turn_start_confirmed":{"title":"Target Turn Start Confirmed","type":"boolean","description":"Bounded target turn start confirmed value accepted by character_disease_exposure_batch."},"within_10_feet_by_target":{"anyOf":[{"additionalProperties":{"type":"boolean"},"type":"object"},{"type":"null"}],"default":null,"title":"Within 10 Feet By Target","description":"Bounded within 10 feet by target value accepted by character_disease_exposure_batch."},"expected_actor_revisions":{"anyOf":[{"additionalProperties":{"type":"integer"},"type":"object"},{"type":"null"}],"default":null,"title":"Expected Actor Revisions","description":"Bounded expected actor revisions value accepted by character_disease_exposure_batch."},"principal_id":{"default":"system:local","title":"Principal Id","type":"string","description":"Caller hint overwritten by process binding or signed Host delegation.","maxLength":256},"expected_revision":{"anyOf":[{"type":"integer"},{"type":"null"}],"default":null,"title":"Expected Revision","description":"Authority revision guard used to reject stale mutations."},"branch_id":{"anyOf":[{"type":"string"},{"type":"null"}],"default":null,"title":"Branch Id","description":"Authoritative timeline branch identifier.","maxLength":256},"idempotency_key":{"anyOf":[{"type":"string"},{"type":"null"}],"default":null,"title":"Idempotency Key","description":"Stable business-operation key reused unchanged across retries.","maxLength":256}},"required":["campaign_id","carrier_actor_id","target_actor_ids","exposure_source_ref","target_turn_start_confirmed"],"title":"character_disease_exposure_batchInput","type":"object"}
```

## character_disease_eyebright_apply
...
```json
{"additionalProperties":false,"properties":{"campaign_id":{"title":"Campaign Id","type":"string","description":"Authoritative campaign identifier.","maxLength":256},"actor_id":{"title":"Actor Id","type":"string","description":"Authoritative campaign actor identifier.","maxLength":256},"disease_effect_id":{"title":"Disease Effect Id","type":"string","description":"Bounded disease effect id value accepted by character_disease_eyebright_apply.","maxLength":256},"ointment_item_id":{"title":"Ointment Item Id","type":"string","description":"Bounded ointment item id value accepted by character_disease_eyebright_apply.","maxLength":256},"principal_id":{"default":"system:local","title":"Principal Id","type":"string","description":"Caller hint overwritten by process binding or signed Host delegation.","maxLength":256},"expected_revision":{"anyOf":[{"type":"integer"},{"type":"null"}],"default":null,"title":"Expected Revision","description":"Authority revision guard used to reject stale mutations."},"expected_actor_revision":{"anyOf":[{"type":"integer"},{"type":"null"}],"default":null,"title":"Expected Actor Revision","description":"Bounded expected actor revision value accepted by character_disease_eyebright_apply."},"branch_id":{"anyOf":[{"type":"string"},{"type":"null"}],"default":null,"title":"Branch Id","description":"Authoritative timeline branch identifier.","maxLength":256},"idempotency_key":{"anyOf":[{"type":"string"},{"type":"null"}],"default":null,"title":"Idempotency Key","description":"Stable business-operation key reused unchanged across retries.","maxLength":256}},"required":["campaign_id","actor_id","disease_effect_id","ointment_item_id"],"title":"character_disease_eyebright_applyInput","type":"object"}
```

## character_disease_eyebright_craft
...
```json
{"additionalProperties":false,"properties":{"campaign_id":{"title":"Campaign Id","type":"string","description":"Authoritative campaign identifier.","maxLength":256},"actor_id":{"title":"Actor Id","type":"string","description":"Authoritative campaign actor identifier.","maxLength":256},"flower_item_id":{"title":"Flower Item Id","type":"string","description":"Bounded flower item id value accepted by character_disease_eyebright_craft.","maxLength":256},"principal_id":{"default":"system:local","title":"Principal Id","type":"string","description":"Caller hint overwritten by process binding or signed Host delegation.","maxLength":256},"expected_revision":{"anyOf":[{"type":"integer"},{"type":"null"}],"default":null,"title":"Expected Revision","description":"Authority revision guard used to reject stale mutations."},"expected_actor_revision":{"anyOf":[{"type":"integer"},{"type":"null"}],"default":null,"title":"Expected Actor Revision","description":"Bounded expected actor revision value accepted by character_disease_eyebright_craft."},"expected_elapsed_ticks":{"anyOf":[{"type":"integer"},{"type":"null"}],"default":null,"title":"Expected Elapsed Ticks","description":"Bounded expected elapsed ticks value accepted by character_disease_eyebright_craft."},"branch_id":{"anyOf":[{"type":"string"},{"type":"null"}],"default":null,"title":"Branch Id","description":"Authoritative timeline branch identifier.","maxLength":256},"idempotency_key":{"anyOf":[{"type":"string"},{"type":"null"}],"default":null,"title":"Idempotency Key","description":"Stable business-operation key reused unchanged across retries.","maxLength":256}},"required":["campaign_id","actor_id","flower_item_id"],"title":"character_disease_eyebright_craftInput","type":"object"}
```
...
```json
{"additionalProperties":false,"properties":{"campaign_id":{"title":"Campaign Id","type":"string","description":"Authoritative campaign identifier.","maxLength":256},"actor_id":{"title":"Actor Id","type":"string","description":"Authoritative campaign actor identifier.","maxLength":256},"trigger":{"title":"Trigger","type":"string","description":"Bounded trigger value accepted by character_disease_stress."},"source_event_id":{"anyOf":[{"type":"string"},{"type":"null"}],"default":null,"title":"Source Event Id","description":"Bounded source event id value accepted by character_disease_stress.","maxLength":256},"principal_id":{"default":"system:local","title":"Principal Id","type":"string","description":"Caller hint overwritten by process binding or signed Host delegation.","maxLength":256},"expected_revision":{"anyOf":[{"type":"integer"},{"type":"null"}],"default":null,"title":"Expected Revision","description":"Authority revision guard used to reject stale mutations."},"expected_actor_revision":{"anyOf":[{"type":"integer"},{"type":"null"}],"default":null,"title":"Expected Actor Revision","description":"Bounded expected actor revision value accepted by character_disease_stress."},"branch_id":{"anyOf":[{"type":"string"},{"type":"null"}],"default":null,"title":"Branch Id","description":"Authoritative timeline branch identifier.","maxLength":256},"idempotency_key":{"anyOf":[{"type":"string"},{"type":"null"}],"default":null,"title":"Idempotency Key","description":"Stable business-operation key reused unchanged across retries.","maxLength":256}},"required":["campaign_id","actor_id","trigger"],"title":"character_disease_stressInput","type":"object"}
```
...
```json
{"additionalProperties":false,"properties":{"campaign_id":{"title":"Campaign Id","type":"string","description":"Authoritative campaign identifier.","maxLength":256},"actor_id":{"title":"Actor Id","type":"string","description":"Authoritative campaign actor identifier.","maxLength":256},"activity":{"title":"Activity","type":"string","description":"Bounded activity value accepted by character_downtime_settle."},"payload":{"additionalProperties":true,"title":"Payload","type":"object","description":"Operation-specific bounded JSON object described by the selected action."},"principal_id":{"default":"system:local","title":"Principal Id","type":"string","description":"Caller hint overwritten by process binding or signed Host delegation.","maxLength":256},"expected_revision":{"anyOf":[{"type":"integer"},{"type":"null"}],"default":null,"title":"Expected Revision","description":"Authority revision guard used to reject stale mutations."},"expected_actor_revision":{"anyOf":[{"type":"integer"},{"type":"null"}],"default":null,"title":"Expected Actor Revision","description":"Bounded expected actor revision value accepted by character_downtime_settle."},"branch_id":{"anyOf":[{"type":"string"},{"type":"null"}],"default":null,"title":"Branch Id","description":"Authoritative timeline branch identifier.","maxLength":256},"idempotency_key":{"anyOf":[{"type":"string"},{"type":"null"}],"default":null,"title":"Idempotency Key","description":"Stable business-operation key reused unchanged across retries.","maxLength":256}},"required":["campaign_id","actor_id","activity","payload"],"title":"character_downtime_settleInput","type":"object"}
```
...
```json
{"additionalProperties":false,"properties":{"character_id":{"title":"Character Id","type":"string","description":"Authoritative player character or NPC identifier.","maxLength":256},"action":{"enum":["effect_add","effect_remove","madness_apply","madness_choose","madness_suppress","madness_cure","resource_set","exhaustion_set","damage","heal","death_save","stabilize","revive","level_advance","resource_sync","source_state","source_traits","statblock_proficiency_sync","stand","knock_prone","breathing_transition","legendary_resistance","bardic_inspiration","divine_smite"],"title":"Action","type":"string","description":"Exact operation supported by this facade.","maxLength":256},"payload":{"anyOf":[{"additionalProperties":true,"type":"object"},{"type":"null"}],"default":null,"title":"Payload","description":"Operation-specific bounded JSON object described by the selected action."},"principal_id":{"default":"system:local","title":"Principal Id","type":"string","description":"Caller hint overwritten by process binding or signed Host delegation.","maxLength":256},"expected_revision":{"anyOf":[{"type":"integer"},{"type":"null"}],"default":null,"title":"Expected Revision","description":"Authority revision guard used to reject stale mutations."},"idempotency_key":{"anyOf":[{"type":"string"},{"type":"null"}],"default":null,"title":"Idempotency Key","description":"Stable business-operation key reused unchanged across retries.","maxLength":256}},"required":["character_id","action"],"title":"character_state_changeInput","type":"object"}
```
...
```json
{"$defs":{"GridCellSearchTarget":{"additionalProperties":false,"properties":{"kind":{"const":"grid_cell","title":"Kind","type":"string"},"x":{"title":"X","type":"integer"},"y":{"title":"Y","type":"integer"}},"required":["kind","x","y"],"title":"GridCellSearchTarget","type":"object"}},"additionalProperties":false,"properties":{"campaign_id":{"title":"Campaign Id","type":"string","description":"Authoritative campaign identifier.","maxLength":256},"actor_id":{"title":"Actor Id","type":"string","description":"Authoritative campaign actor identifier.","maxLength":256},"kind":{"title":"Kind","type":"string","description":"Bounded kind value accepted by combat_check.","maxLength":256},"ability":{"default":"","title":"Ability","type":"string","description":"Bounded ability value accepted by combat_check."},"target_id":{"anyOf":[{"type":"string"},{"type":"null"}],"default":null,"title":"Target Id","description":"Bounded target id value accepted by combat_check.","maxLength":256},"action":{"anyOf":[{"type":"string"},{"type":"null"}],"default":null,"title":"Action","description":"Exact operation supported by this facade.","maxLength":256},"dc":{"default":0,"title":"Dc","type":"integer","description":"Bounded D&D difficulty class used by the authoritative check."},"proficient":{"default":false,"title":"Proficient","type":"boolean","description":"Bounded proficient value accepted by combat_check."},"bonus":{"default":0,"title":"Bonus","type":"integer","description":"Bounded bonus value accepted by combat_check."},"advantage":{"default":false,"title":"Advantage","type":"boolean","description":"Bounded advantage value accepted by combat_check."},"disadvantage":{"default":false,"title":"Disadvantage","type":"boolean","description":"Bounded disadvantage value accepted by combat_check."},"rule_facts":{"anyOf":[{"additionalProperties":true,"type":"object"},{"type":"null"}],"default":null,"title":"Rule Facts","description":"Bounded rule facts value accepted by combat_check."},"search_target":{"anyOf":[{"$ref":"#/$defs/GridCellSearchTarget"},{"type":"null"}],"default":null,"description":"Bounded search target value accepted by combat_check."},"spatial_facts":{"anyOf":[{"additionalProperties":true,"type":"object"},{"type":"null"}],"default":null,"title":"Spatial Facts","description":"Bounded spatial facts value accepted by combat_check."},"principal_id":{"default":"system:local","title":"Principal Id","type":"string","description":"Caller hint overwritten by process binding or signed Host delegation.","maxLength":256},"expected_revision":{"anyOf":[{"type":"integer"},{"type":"null"}],"default":null,"title":"Expected Revision","description":"Authority revision guard used to reject stale mutations."},"branch_id":{"anyOf":[{"type":"string"},{"type":"null"}],"default":null,"title":"Branch Id","description":"Authoritative timeline branch identifier.","maxLength":256},"idempotency_key":{"anyOf":[{"type":"string"},{"type":"null"}],"default":null,"title":"Idempotency Key","description":"Stable business-operation key reused unchanged across retries.","maxLength":256},"check_context":{"anyOf":[{"additionalProperties":true,"type":"object"},{"type":"null"}],"default":null,"title":"Check Context","description":"Bounded check context value accepted by combat_check."}},"required":["campaign_id","actor_id","kind"],"title":"combat_checkInput","type":"object"}
```
...
```json
{"additionalProperties":false,"properties":{"campaign_id":{"title":"Campaign Id","type":"string","description":"Authoritative campaign identifier.","maxLength":256},"actor_id":{"title":"Actor Id","type":"string","description":"Authoritative campaign actor identifier.","maxLength":256},"principal_id":{"default":"system:local","title":"Principal Id","type":"string","description":"Caller hint overwritten by process binding or signed Host delegation.","maxLength":256},"expected_revision":{"anyOf":[{"type":"integer"},{"type":"null"}],"default":null,"title":"Expected Revision","description":"Authority revision guard used to reject stale mutations."},"branch_id":{"anyOf":[{"type":"string"},{"type":"null"}],"default":null,"title":"Branch Id","description":"Authoritative timeline branch identifier.","maxLength":256},"idempotency_key":{"anyOf":[{"type":"string"},{"type":"null"}],"default":null,"title":"Idempotency Key","description":"Stable business-operation key reused unchanged across retries.","maxLength":256},"confusion_direction_map":{"anyOf":[{"additionalProperties":{"additionalProperties":{"type":"integer"},"type":"object"},"type":"object"},{"type":"null"}],"default":null,"title":"Confusion Direction Map","description":"Bounded confusion direction map value accepted by combat_end_turn."}},"required":["campaign_id","actor_id"],"title":"combat_end_turnInput","type":"object"}
```
...
```json
{"additionalProperties":false,"properties":{"campaign_id":{"title":"Campaign Id","type":"string","description":"Authoritative campaign identifier.","maxLength":256},"payload":{"additionalProperties":true,"title":"Payload","type":"object","description":"Operation-specific bounded JSON object described by the selected action."},"action":{"default":"water","enum":["water","object_strength_review","fire_source_review"],"title":"Action","type":"string","description":"Exact operation supported by this facade.","maxLength":256},"principal_id":{"default":"system:local","title":"Principal Id","type":"string","description":"Caller hint overwritten by process binding or signed Host delegation.","maxLength":256},"expected_revision":{"anyOf":[{"type":"integer"},{"type":"null"}],"default":null,"title":"Expected Revision","description":"Authority revision guard used to reject stale mutations."},"branch_id":{"anyOf":[{"type":"string"},{"type":"null"}],"default":null,"title":"Branch Id","description":"Authoritative timeline branch identifier.","maxLength":256},"idempotency_key":{"anyOf":[{"type":"string"},{"type":"null"}],"default":null,"title":"Idempotency Key","description":"Stable business-operation key reused unchanged across retries.","maxLength":256}},"required":["campaign_id","payload"],"title":"environment_changeInput","type":"object","allOf":[{"if":{"properties":{"action":{"const":"water"}},"required":["action"]},"then":{"properties":{"payload":{"additionalProperties":false,"properties":{"source_ref":{"additionalProperties":true,"title":"Source Ref","type":"object"},"source_excerpt":{"title":"Source Excerpt","type":"string"},"reason":{"title":"Reason","type":"string"},"actors":{"default":[],"items":{"additionalProperties":true,"type":"object"},"title":"Actors","type":"array"},"objects":{"default":[],"items":{"additionalProperties":true,"type":"object"},"title":"Objects","type":"array"}},"required":["source_ref","source_excerpt","reason"],"title":"WaterEnvironment","type":"object"}},"required":["payload"]}},{"if":{"properties":{"action":{"const":"object_strength_review"}},"required":["action"]},"then":{"properties":{"payload":{"additionalProperties":false,"properties":{"object":{"additionalProperties":true,"title":"Object","type":"object"},"object_source_ref":{"additionalProperties":true,"title":"Object Source Ref","type":"object"},"object_ruling":{"additionalProperties":true,"title":"Object Ruling","type":"object"},"strength_check":{"additionalProperties":true,"title":"Strength Check","type":"object"}},"required":["object","object_source_ref","object_ruling","strength_check"],"title":"SceneObjectStrengthReview","type":"object"}},"required":["payload"]}},{"if":{"properties":{"action":{"const":"fire_source_review"}},"required":["action"]},"then":{"properties":{"payload":{"additionalProperties":false,"properties":{"active":{"title":"Active","type":"boolean"},"reason":{"title":"Reason","type":"string"},"fire_source_id":{"anyOf":[{"maxLength":256,"minLength":1,"type":"string"},{"type":"null"}],"default":null,"title":"Fire Source Id"},"cell":{"anyOf":[{"additionalProperties":true,"type":"object"},{"type":"null"}],"default":null,"title":"Cell"},"level_ground_surface":{"anyOf":[{"type":"boolean"},{"type":"null"}],"default":null,"title":"Level Ground Surface"},"source_ref":{"anyOf":[{"additionalProperties":true,"type":"object"},{"type":"null"}],"default":null,"title":"Source Ref"},"source_excerpt":{"anyOf":[{"type":"string"},{"type":"null"}],"default":null,"title":"Source Excerpt"}},"required":["active","reason"],"title":"FireSourceReview","type":"object"}},"required":["payload"]}}]}
```
...
```json
{"additionalProperties":false,"properties":{"campaign_id":{"title":"Campaign Id","type":"string","description":"Authoritative campaign identifier.","maxLength":256},"trap_id":{"title":"Trap Id","type":"string","description":"Bounded trap id value accepted by trap_state_transition.","maxLength":256},"action":{"title":"Action","type":"string","description":"Exact operation supported by this facade.","maxLength":256},"source_ref":{"title":"Source Ref","type":"string","description":"Bounded source ref value accepted by trap_state_transition."},"source_excerpt":{"title":"Source Excerpt","type":"string","description":"Bounded source excerpt value accepted by trap_state_transition."},"profile":{"additionalProperties":true,"title":"Profile","type":"object","description":"Bounded profile value accepted by trap_state_transition."},"actor_id":{"title":"Actor Id","type":"string","description":"Authoritative campaign actor identifier.","maxLength":256},"principal_id":{"default":"system:local","title":"Principal Id","type":"string","description":"Caller hint overwritten by process binding or signed Host delegation.","maxLength":256},"expected_revision":{"anyOf":[{"type":"integer"},{"type":"null"}],"default":null,"title":"Expected Revision","description":"Authority revision guard used to reject stale mutations."},"branch_id":{"anyOf":[{"type":"string"},{"type":"null"}],"default":null,"title":"Branch Id","description":"Authoritative timeline branch identifier.","maxLength":256},"idempotency_key":{"anyOf":[{"type":"string"},{"type":"null"}],"default":null,"title":"Idempotency Key","description":"Stable business-operation key reused unchanged across retries.","maxLength":256},"method":{"anyOf":[{"type":"string"},{"type":"null"}],"default":null,"title":"Method","description":"Bounded method value accepted by trap_state_transition."},"target_ids":{"anyOf":[{"items":{"type":"string"},"type":"array"},{"type":"null"}],"default":null,"title":"Target Ids","description":"Bounded target ids value accepted by trap_state_transition."},"area_confirmed":{"anyOf":[{"type":"boolean"},{"type":"null"}],"default":null,"title":"Area Confirmed","description":"Bounded area confirmed value accepted by trap_state_transition."},"trap_depth_ft":{"anyOf":[{"type":"integer"},{"type":"null"}],"default":null,"title":"Trap Depth Ft","description":"Bounded trap depth ft value accepted by trap_state_transition."},"trigger_fact":{"anyOf":[{"additionalProperties":true,"type":"object"},{"type":"null"}],"default":null,"title":"Trigger Fact","description":"Bounded trigger fact value accepted by trap_state_transition."},"scene_facts":{"anyOf":[{"additionalProperties":true,"type":"object"},{"type":"null"}],"default":null,"title":"Scene Facts","description":"Bounded scene facts value accepted by trap_state_transition."},"spatial_facts":{"anyOf":[{"additionalProperties":true,"type":"object"},{"type":"null"}],"default":null,"title":"Spatial Facts","description":"Bounded spatial facts value accepted by trap_state_transition."},"rescue_target_id":{"anyOf":[{"type":"string"},{"type":"null"}],"default":null,"title":"Rescue Target Id","description":"Bounded rescue target id value accepted by trap_state_transition.","maxLength":256},"rescue_facts":{"anyOf":[{"additionalProperties":true,"type":"object"},{"type":"null"}],"default":null,"title":"Rescue Facts","description":"Bounded rescue facts value accepted by trap_state_transition."},"contact_facts":{"anyOf":[{"additionalProperties":true,"type":"object"},{"type":"null"}],"default":null,"title":"Contact Facts","description":"Bounded contact facts value accepted by trap_state_transition."}},"required":["campaign_id","trap_id","action","source_ref","source_excerpt","profile","actor_id"],"title":"trap_state_transitionInput","type":"object"}
```
