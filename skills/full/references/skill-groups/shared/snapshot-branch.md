...
Verify before restore. After restore or checkout, discard cached state, call
`campaign_query(view="resume")`, cross any changed host context binding, and
read current campaign, branch, scene, characters, and continuity again.
Use the Host-selected public tools for the current phase.
